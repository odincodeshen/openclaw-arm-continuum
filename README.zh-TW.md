...
|---|---|---|
| `personal_tracker_memory` | `memory:` | 動態個人記憶、todo、決策、追蹤資料、網頁擷取內容 |
| `personal_knowledge_base` | `knowledge:` | 長期文件知識庫、技術手冊、白皮書、正式匯入文件 |
...
正式圖片/PDF/架構圖解析建議未來切換到明確 VLM，例如 Qwen2.5-VL 或 Qwen3-VL。
